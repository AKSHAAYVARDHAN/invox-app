    ...
    if (loading) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center bg-[#080808] gap-4">
                <div className="w-10 h-10 border-2 border-zinc-800 border-t-white animate-spin"></div>
                <p className="font-mono text-xs text-zinc-500 tracking-widest uppercase animate-pulse">// INITIALIZING INVOX...</p>
            </div>
        );
    }
