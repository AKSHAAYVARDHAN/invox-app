        ...
        if (navigator.share) {
            try {
                await navigator.share({
                    title: post.aiSummary || 'Invox Query',
                    text: post.content,
        ...
        <>
            <div className="bg-[#0c0c0e] border border-zinc-800/90 hover:border-zinc-700/80 p-4 mb-4 transition-all duration-150">
                ...
                <div className="flex items-center justify-between border-b border-zinc-800/60 pb-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-mono text-zinc-500 mt-0.5">// TYPE: QUERY</p>
                        </div>
                    </div>
                ...
                <div className="mt-4 border-t border-zinc-800/80 pt-3 flex justify-between items-center font-mono text-xs text-zinc-400">
                    ...
                    <button 
                        ...
                        className={`flex items-center gap-1.5 px-2 py-1 border transition-colors ${
                            isInsightsOpen ? 'text-white border-zinc-700 bg-zinc-850' : 'border-transparent hover:border-zinc-800 hover:text-white'
                        }`} 
                        aria-label={isInsightsOpen ? "Collapse insights" : "View insights"}
                    >
                ...
                <div className="mt-3">
                    ...
                    >
                        <span>{isInsightsOpen ? '// CLOSE INSIGHTS' : '// SHARE INSIGHTS'}</span>
                    </button>
                </div>

                {/* Inline Expandable Insight Section */}
                <InsightSection
                    post={post}
