...
export const QueryCard: React.FC<{ post: Post }> = ({ post }) => {
        ...
        <>
            <div className="bg-invox-dark-accent rounded-lg border border-gray-800 p-4 mb-4">
                ...
                <div className="mt-4 border border-gray-800 rounded-lg px-4 py-2 flex justify-around items-center">
                    <button className="flex items-center gap-1.5 text-invox-light-gray hover:text-white transition-all duration-200 transform hover:scale-110 active:scale-100" aria-label="Upvote query">
                    ...
                    <button className="flex items-center gap-1.5 text-invox-light-gray hover:text-white transition-all duration-200 transform hover:scale-110 active:scale-100" aria-label="View insights">
                        <PresentationChartBarIcon className="w-5 h-5" />
                        <span className="text-sm font-semibold">{formatNumber(post.stats.comments)}</span>
                    </button>
                    <button className="text-invox-light-gray hover:text-white transition-all duration-200 transform hover:scale-110 active:scale-100" aria-label="Share query">
                        <ForwardIcon className="w-5 h-5" />
                    </button>
                    <button className="text-invox-light-gray hover:text-white transition-all duration-200 transform hover:scale-110 active:scale-100" aria-label="Save query">
