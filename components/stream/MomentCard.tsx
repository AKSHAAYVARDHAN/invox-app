...
const MomentCard: React.FC<{ moment: StreamMoment }> = ({ moment }) => {
    ...
    const isLongContent = moment.content.length > 150;
                            ...
                            {isVisible ? (
                                isVideo ? (
                                    <>
                                     ...
                                     <img src={moment.mediaUrl} onError={handleImageError} alt="Post content" className="w-full h-full object-cover" />
                                )
                            ) : (
                                <MediaPlaceholder thumbnailUrl={moment.thumbnailUrl} isVideo={isVideo} />
                            )}
                        </AspectRatioBox>
